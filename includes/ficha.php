...
>
    <div class="ficha__card">
        ...
        <section class="ficha-galeria" aria-label="Imágenes del producto">
            <?php if ($aplicarDescuento && $descuentoPct > 0): ?>
                <span class="ficha-descuento">-<?= $descuentoPct ?>%</span>
            <?php endif; ?>

            <figure class="ficha-galeria__hero" aria-label="Opciones de imagen del producto">
                <img
        ...
        <section class="ficha-tallas" aria-label="Selección de talla">
            <div class="ficha-tallas__grid" role="radiogroup" aria-label="Tallas disponibles">
                ...
                foreach ($producto['tallas'] as $talla):
                    ...
                    <button
                        type="button"
                        class="ficha-talla<?= $disponible ? '' : ' is-agotada' ?>"
        ...
        <div class="ficha-galeria__thumbs" role="listbox" aria-label="Colores disponibles">
        ...
        <footer class="ficha-accion">
            <div class="ficha-accion__cta-wrap" hidden>
                <button
                    type="button"
                    class="ficha-accion__cta is-activo"
                    aria-label="Lo quiero"
                >
                    LO QUIERO
                </button>
            </div>
            <p class="ficha-accion__ayuda" data-ayuda-cta>
    ...
    <div class="ficha-sticky" data-ficha-sticky aria-hidden="true">
        <div class="ficha-sticky__contenido">
            <div class="ficha-sticky__talla" data-sticky-talla-wrap>
                <span class="ficha-sticky__talla-etiq">Talla</span>
                <span class="ficha-sticky__talla-valor" data-sticky-talla>—</span>
            </div>
            <p class="ficha-sticky__precio" data-sticky-precio aria-label="Precio"><?= h(formatear_precio($precio)) ?></p>
            <button type="button" class="ficha-sticky__cta" data-sticky-cta hidden aria-label="Lo quiero">LO QUIERO</button>
        </div>
    </div>
</article>
