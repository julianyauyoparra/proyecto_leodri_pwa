...
<article
    ...
    id="producto-<?= h((string) ($producto['id'] ?? '')) ?>"
    ...
    <?php endif; ?>
    aria-label="Producto <?= h($tituloTienda) ?>"
>
    <div class="ficha__card ficha__card--home">
        ...
        <div class="ficha-precios ficha-precios--home" aria-label="Precios">
            ...
            <?php endif; ?>
            <div class="ficha-precios__fila ficha-precios__fila--actual">
        ...
        <div class="ficha-home-info">
            ...
            <h3 class="ficha-home-info__nombre"><?= h($tituloTienda) ?></h3>
            <span
